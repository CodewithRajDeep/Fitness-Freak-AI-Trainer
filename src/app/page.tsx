      ...
      <section className='relative z-10 py-24 flex-grow'>
        <div className='container mx-auto px-4'>
           <div className='grid grid-cols-1 lg:grid-cols-12 gap-8 items-center relative'>
            {/**Corner Decoration  */}
             <div className='absolute -top-6 left-0 w-15 h-15 border-l-2 border-t-2 border-border'/>
               ...
               <div className='lg:col-span-5 relative'>
                 ...
                 <div className='relative aspect-square max-w-lg mx-auto'>
                   <div className='relative overflow-hidden rounded-lg bg-black'></div>
                      <img src="/fitness.jpg" alt="AI coach" className='size-full object-cover object-center'/>
                  </div>
                   <div className="absolute inset-0 bg-[linear-gradient(transparent_0%,transparent_calc(50%-1px),var(--glow-primary)_50%,transparent_calc(50%+1px),transparent_100%)] bg-[length:100%_8px] animate-scanline pointer-events-none" />
                  
                  <div className='absolute inset-0 pointer-events-none'>
                     <div className='absolute top-1/3 left-1/3 w-1/3 h-1/3 border border-primary/40 rounded-full'/>

                     <div className='absolute top-1/2 left-0 w-1/4 h-px bg-primary/50 opacity-70'/>
                     <div className='absolute top-1/2 right-0 w-1/4 h-px bg-primary/50 opacity-70'/>
                     <div className='absolute top-0 left-1/2 h-1/4 w-px bg-primary/50 opacity-70'/>
                     <div className='absolute bottom-0 left-1/2 h-1/4 w-px bg-primary/50 opacity-70'/>
